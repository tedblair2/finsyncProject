    ...
    <div class="login-box w-full sm:w-96">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                ...
                <input class="form-control w-full p-3 border border-indigo-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
            ...
            <div class="text-center d-grid mb-4">
                <button type="submit" class="btn btn-primary text-white w-full py-3 text-lg font-medium rounded-lg">
                    Log In
                </button>
            </div>
